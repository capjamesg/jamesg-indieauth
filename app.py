from flask import request, Flask, jsonify, render_template, redirect, flash, session, current_app
from config import TWITTER_OAUTH_KEY, TWITTER_OAUTH_SECRET, ME, GITHUB_CLIENT_ID, GITHUB_OAUTH_REDIRECT, GITHUB_CLIENT_SECRET, \
    OKTA_DOMAIN, OKTA_USER_ID, OKTA_FACTOR_ID, OKTA_ACCESS_TOKEN, SECRET_KEY
